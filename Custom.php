            ...
            <div class="row justify-content-center">
               <div class="col-xxl-9">
                  <div class="page-title-wrapper text-center">
                     <h3 style="color:white">Custom Clearance</h3>
                     <div class="breadcrumb-menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                           <ul class="trail-items">
                              <li class="trail-item trail-begin"><a href="index.php"><span>Home</span></a></li>
                              <li class="trail-item trail-end"><span>Custom Clearance</span></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
               ...
               <div class="col-md-6 ">
                  <div class="about__3-img-wrapper p-relative mb-60">
                     ...
                     <div class="about__3-main w-img">
                        <img src="assets/img/about/24.jpg" alt="About">
                     </div>
               ...
               <div class="col-md-6 ">
                  <div class="about__3-content mb-60">
                     ...
                     <div class="about__3-content-inner p-relative">
                        <div >
                           <p>Vayu Aviation provides customs clearance services as part of their comprehensive logistics offerings. Customs clearance is a crucial aspect of international trade and involves the necessary procedures and documentation required to comply with customs regulations and facilitate the smooth movement of goods across borders. Here's an overview of Vayu Aviation's customs clearance services
</p>
            ...
            <div class="row">
               <div class=" col-md-6">
                  <div class="services__3-item mb-30">
                     ...
                     <div class="services__3-item-icon">
                        <img src="assets/img/about/25.jpg" alt="About" style="height:100px;width:100px;">
                     </div>
                     <h3 ><a href="#">Documentation Preparation</a></h3>
                     <p class="services__3-item-text"> Vayu Aviation assists in the preparation and submission of the required customs documentation. This includes preparing and verifying documents such as commercial invoices, packing lists, bills of lading, customs declarations, certificates of origin, and any other necessary paperwork based on the specific requirements of the importing and exporting countries.
                     </p>
                  </div>
               </div>
               <div class=" col-md-6">
                  <div class="services__3-item mb-30">
                     ...
                     <div class="services__3-item-icon">
                        <img src="assets/img/about/26.jpg" alt="About" style="height:100px;width:100px;">
                     </div>
                     <h3 ><a href="#">Compliance and Regulatory Expertise</a></h3>
                     <p class="services__3-item-text">Vayu Aviation stays up to date with the customs regulations and trade compliance requirements of different countries. WE have expertise in navigating the complex customs procedures and ensuring that shipments adhere to all applicable rules and regulations. This helps businesses avoid delays, penalties, and customs-related issues.
                     </p>
                  </div>
               </div>
               <div class=" col-md-6">
                  <div class="services__3-item mb-30">
                     ...
                     <div class="services__3-item-icon">
                       <img src="assets/img/about/27.jpg" alt="About" style="height:100px;width:100px;">
                     </div>
                     <h3 ><a href="#">Customs Classification</a></h3>
                     <p class="services__3-item-text">Vayu Aviation acts as a customs broker on behalf of their clients. WE liaise with customs authorities and handle all necessary communication, documentation, and payment of customs duties, taxes, and fees. This includes managing import and export permits, licenses, and clearances required by the customs authorities.
               ...
               <div class=" col-md-6">
                  <div class="services__3-item mb-30">
                     ...
                     <div class="services__3-item-icon">
                       <img src="assets/img/about/28.jpg" alt="About" style="height:100px;width:100px;">
                     </div>
                     <h3><a href="#">Customs Brokerage</a></h3>
                     <p class="services__3-item-text"> Vayu Aviation acts as a customs broker on behalf of their clients. WE liaise with customs authorities and handle all necessary communication, documentation, and payment of customs duties, taxes, and fees. This includes managing import and export permits, licenses, and clearances required by the customs authorities.
               ...
               <div class=" col-md-6">
                  <div class="services__3-item mb-30">
                     ...
                     <div class="services__3-item-icon">
                       <img src="assets/img/about/29.jpg" alt="About" style="height:100px;width:100px;">
                     </div>
                     <h3 ><a href="#">Duty and Tax Assessment</a></h3>
                     <p class="services__3-item-text">Vayu Aviation provides assistance in determining the applicable customs duties, taxes, and fees associated with the import or export of goods. WE help businesses understand the cost implications and ensure accurate assessment and payment of these charges to the customs authorities.
                     </p>
                  </div>
               </div>
               <div class=" col-md-6">
                  <div class="services__3-item mb-30">
                     ...
                     <div class="services__3-item-icon">
                       <img src="assets/img/about/30.jpg" alt="About" style="height:100px;width:100px;">
                     </div>
                     <h3 ><a href="#">Risk Management and Compliance</a></h3>
                     <p class="services__3-item-text"> Vayu Aviation ensures that all customs clearance processes are conducted in compliance with the relevant regulations and requirements. WE help manage potential risks associated with customs compliance, including tariff classification disputes, valuation issues, and other compliance-related challenges.
                     </p>
                  </div>
               </div>
            </div>
