...
<body>
   ...
   <main>
            ...
            <div class="row justify-content-center">
               <div class="col-xxl-9">
                  <div class="page-title-wrapper text-center">
                     <h3 style="color:white">Sales & Marketing</h3>
                     <div class="breadcrumb-menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                           <ul class="trail-items">
                              <li class="trail-item trail-begin"><a href="index.php"><span>Home</span></a></li>
                              <li class="trail-item trail-end"><span>Sales & Marketing</span></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
      ...
      <section class="about__3 about__gray-bg p-relative pt-120 pb-60 wow fadeInUp" data-wow-duration="1.5s"
               ...
               <div class="col-md-6 ">
                  <div class="about__3-img-wrapper p-relative mb-60">
                     ...
                     <div class="about__3-main w-img">
                        <img src="assets/img/about/53.jpg" alt="About">
                     </div>
	   ...
	   <section class="about__3  p-relative  pb-60 wow fadeInUp" data-wow-duration="1.5s"
         data-wow-delay=".3s">
         <div class="container">
            <div class="row align-items-center">
			  ...
			  <div class="col-md-6 ">
                  <div class="about__3-img-wrapper p-relative mb-60">
                     ...
                     <div class="about__3-main w-img">
                        <img src="assets/img/about/58.jpg" alt="About">
                     </div>
...
<section class="about__3 about__gray-bg p-relative pt-120 pb-60 wow fadeInUp" data-wow-duration="1.5s"
         data-wow-delay=".3s" style="margin-top:-175px">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-md-6 ">
                  <div class="about__3-img-wrapper p-relative mb-60">
                     ...
                     <div class="about__3-main w-img">
                        <img src="assets/img/about/60.jpg" alt="About">
                     </div>
