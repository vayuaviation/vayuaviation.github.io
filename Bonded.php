            ...
            <div class="row justify-content-center">
               <div class="col-xxl-9">
                  <div class="page-title-wrapper text-center">
                     <h3 style="color:white">Bonded & Non Bonded</h3>
                     <div class="breadcrumb-menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                           <ul class="trail-items">
                              <li class="trail-item trail-begin"><a href="index.php"><span>Home</span></a></li>
                              <li class="trail-item trail-end"><span>Bonded & Non Bonded</span></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
               ...
               <div class="col-md-6 ">
                  <div class="about__3-img-wrapper p-relative mb-60">
                     ...
                     <div class="about__3-main w-img">
                        <img src="assets/19962590_6184638.jpg" alt="About">
                     </div>
               ...
               <div class="col-md-6 ">
                  <div class="about__3-content mb-60">
                     <div class="section__title mb-30">
                        <span >Bonded & Non Bonded</span>
                        <h3 >Bonded / Non Bonded</h3>
                     </div>
                     <div class="about__3-content-inner p-relative">
                        <div >
                           <p>Vayu provides and having the air cargo Bonded & Non Bonded trucking tie up with the Indian Customs approved RFS service providers like TT Trucking, Shreeji Transport, Oscar Freight etc
                           </p>
                        </div>
